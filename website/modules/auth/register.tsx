  ...
  return(
      <form className="w-full" onSubmit={handleSubmit(async (formData) => {
        ...
        <div className="h-screen md:flex">
          <div
            className="relative overflow-hidden md:flex rounded w-1/2 bg-[url(https://c1.wallpaperflare.com/preview/835/704/875/drink-fruit-glass-grape.jpg)] i justify-around items-center hidden">
          </div>
